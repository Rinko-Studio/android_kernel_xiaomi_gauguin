...
static struct snd_soc_dai_link msm_common_dai_links[] = {
	...
	{/* hw:x,30 */
		...
		.name = "Tertiary TDM1 Hostless",
		.stream_name = "Tertiary TDM1 Hostless",
...
static struct snd_soc_dai_link msm_common_misc_fe_dai_links[] = {
	...
	{/* hw:x,42 */
		.name = "Tertiary TDM0 Hostless",
		.stream_name = "Tertiary TDM0 Hostless",
...
#ifndef CONFIG_TARGET_SUPPORT_TDM
	{
...
static struct snd_soc_dai_link tert_mi2s_rx_cs35l41_be_dai_links[] = {
#ifdef CONFIG_TARGET_SUPPORT_TDM
	{
		.name = LPASS_BE_TERT_TDM_RX_0,
		.stream_name = "Tertiary TDM0 Playback",
